...
if(localuser.toUpperCase() !== user.toUpperCase()) {
        if (document.getElementsByClassName("overview")[0].innerHTML.toLowerCase().includes("scratchmoji.tk") || document.getElementsByClassName("overview")[1].innerHTML.toLowerCase().includes("scratchmoji.tk")) {
