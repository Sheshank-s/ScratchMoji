...
function handleEmojis() {
    ...
    var emojisdash = {
        ...
        "<3": '<img style="vertical-align: bottom; display: inline; height: 21px; width: 21px;" src="https://greenbayrules.github.io/host/emojis/faceemoji/heart.png" alt="_<3_" title="_<3_" class="emoji">',
