...
document.addEventListener('DOMContentLoaded', function() {
  ...
  var emojisdash = {
   ...
   document.getElementById("container").innerHTML += "<br> <b>People:</b> <br>";
    ...
    for (var i = 0; i < peoplelistOfValues.length; i++) {
      ...
      document.getElementById(peoplelistOfProperties[i]).addEventListener("click",  function() {copyT("_"+peoplelistOfProperties[i]+"_")});
    }
   //Animals
  ...
  document.getElementById("container").innerHTML += "<br> <b>Animals:</b> <br>";
   ...
   for (var i = 0; i < animallistOfValues.length; i++) {
     ...
     document.getElementById(animallistOfProperties[i]).addEventListener("click", function() { copyT("_"+animallistOfProperties[i]+"_")});
   }
   //Potato
  ...
  for (var i = 0; i < customlistOfValues.length; i++) {
    ...
    document.getElementById(customlistOfProperties[i]).onclick = function() {copy(document.getElementById(customlistOfProperties[i]).id)};
  }
});
